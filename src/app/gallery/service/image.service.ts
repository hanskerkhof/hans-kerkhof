...
export class ImageService {
  ...
  imagesUpdated$: Observable<
    Array<any>
  > = this.imagesUpdatedSource.asObservable();
  imageSelectedIndexUpdated$: Observable<
    number
  > = this.imageSelectedIndexUpdatedSource.asObservable();
  showImageViewerChanged$: Observable<
    boolean
  > = this.showImageViewerSource.asObservable();
